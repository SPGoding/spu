...
class Checker {
    ...
    static isBlockDustParam(input) {
        return utils_1.isNumeric(input) && Number(input) >= 0 && Number(input) <= 255 + 15 * 4096;
    }
...
class Blocks {
    ...
    static std1_12(id, name, data, state, nbt) {
        let ansName;
        let ansStates;
        let ansNbt;
        if (id && !name && !state) {
        ...
        switch (ansName) {
            case 'minecraft:white_banner': {
                {
                    ...
                    if (customName instanceof nbt_1.NbtString) {
                        customName.set(updater_1.default.upPreJson(customName.get()));
                    }
                }
                {
                    ...
                    if (base instanceof nbt_1.NbtInt) {
                        ansName = `${items_1.default.getNominalColorFromNumericColor(15 - base.get(), 'banner')}`;
                    }
                }
                {
            ...
            case 'minecraft:white_wall_banner': {
                ...
                }
                {
                    ...
                    ansNbt.del('Base');
                    if (base instanceof nbt_1.NbtInt) {
                        ansName = `${items_1.default.getNominalColorFromNumericColor(base.get(), 'wall_banner')}`;
                    }
                }
                {
                    const patterns = ansNbt.get('Patterns');
            ...
            case 'minecraft:red_bed': {
                {
                    ...
                    ansNbt.del('color');
                    if (color instanceof nbt_1.NbtInt) {
                        ansName = items_1.default.getNominalColorFromNumericColor(color.get(), 'bed');
                    }
                }
                break;
            }
            case 'minecraft:cauldron': {
                {
                    ...
                    if (items instanceof nbt_1.NbtList) {
                        for (let i = 0; i < items.length; i++) {
                            ...
                            item = utils_1.getNbt(updater_1.default.upItemNbt(item.toString()));
                            items.set(i, item);
                        }
                    }
                }
            ...
            case 'minecraft:chain_command_block': {
                ...
                }
                {
                    ...
                    if (command instanceof nbt_1.NbtString) {
                        command.set(updater_1.default.upCommand(command.get(), false));
                    }
                }
                break;
            }
            case 'minecraft:potted_cactus': {
                {
                    ...
                    if (item instanceof nbt_1.NbtString && data instanceof nbt_1.NbtInt) {
                        ansName = `minecraft:potted_${Blocks.get1_13(Blocks.std1_12(undefined, item.get(), data.get()))
            ...
            case 'minecraft:mob_spawner': {
                        ...
                        for (let i = 0; i < spawnPotentials.length; i++) {
                            ...
                            if (potential instanceof nbt_1.NbtCompound) {
                                ...
                                if (entity instanceof nbt_1.NbtCompound) {
                                    entity = utils_1.getNbt(updater_1.default.upEntityNbt(entity.toString()));
                ...
                }
                {
                    ...
                    if (spawnData instanceof nbt_1.NbtCompound) {
                        spawnData = utils_1.getNbt(updater_1.default.upEntityNbt(spawnData.toString()));
            ...
            case 'minecraft:note_block': {
                {
                    ...
                    if ((note instanceof nbt_1.NbtByte || note instanceof nbt_1.NbtInt) &&
                        ...
                        ansStates = Blocks.combineStates(ansStates, [`pitch=${note.get()}`, `powered=${powered.get() !== 0}`]);
                    }
            ...
            case 'minecraft:piston': {
                {
                    ...
                    if (blockID instanceof nbt_1.NbtInt &&
                        (blockData instanceof nbt_1.NbtInt || blockData === undefined)) {
            ...
            case 'minecraft:sign': {
                {
                    ...
                    if (text instanceof nbt_1.NbtString) {
                        text.set(updater_1.default.upJson(text.get()));
                    }
                }
                {
    ...
    static upStringToBlockState(id, data) {
        const blockState = new nbt_1.NbtCompound();
        const name = new nbt_1.NbtString();
        const properties = new nbt_1.NbtCompound();
        const metadata = data ? data.get() : 0;
...
Blocks.Nominal1_12_Nominal1_13 = [
...
},{"../updater":12,"../utils/nbt/nbt":15,"../utils/utils":19,"./items":7}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Effects {
                ...
                switch (name) {
                    ...
                    case 'addMetadataOrStateToBlock':
                        if (utils_1.isNumeric(params[0])) {
                            source = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, source, Number(params[0]))).getFull();
                        }
                        else {
                            source = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, source, undefined, params[0])).getFull();
                        }
                        break;
                    case 'addMetadataOrStateAndNbtToBlock':
                        if (utils_1.isNumeric(params[0])) {
                            source = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, source, Number(params[0]), undefined, params[1])).getFull();
                        }
                        else {
                            source = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, source, undefined, params[0], params[1])).getFull();
                        }
                        break;
                    case 'addNbtToEntity': {
                        let sel = new selector_1.default();
                    ...
                    case 'fuckBlockItself':
                        source = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, source)).getFull();
                        break;
                    default:
...
class Updater {
    ...
    static upBlockDustParam(input) {
        ...
        const nominal = blocks_1.default.get1_13(blocks_1.default.std1_12(num)).getFull();
        return nominal;
    }
    ...
    static upEntityNbt(input) {
        ...
        }
        {
            ...
            if (block instanceof nbt_1.NbtString && tileEntityData instanceof nbt_1.NbtCompound &&
                ...
                tileEntityData = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, block.get(), data ? data.get() : 0, undefined, tileEntityData.toString())).getNbt();
    ...
    static upBlockNumericIDToBlockState(id, data) {
        ...
        const properties = new nbt_1.NbtCompound();
        const metadata = data ? data.get() : 0;
        const std = blocks_1.default.get1_13(blocks_1.default.std1_12(id.get(), undefined, metadata));
        name.set(std.getName());
        if (std.hasStates()) {
            std.getStates()
                .forEach(v => {
        ...
        const root = utils_1.getNbt(nbt);
        {
            ...
            if (canDestroy instanceof nbt_1.NbtList) {
                for (let i = 0; i < canDestroy.length; i++) {
                    ...
                    if (block instanceof nbt_1.NbtString) {
                        block.set(blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, block.get(), 0)).getName());
        ...
        }
        {
            if (blocks_1.default.is1_12StringID(item)) {
                ...
                if (blockEntityTag instanceof nbt_1.NbtCompound) {
                    blockEntityTag = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, item, undefined, undefined, blockEntityTag.toString())).getNbt();
            ...
            switch (subs[1]) {
                case 'mineBlock':
                    ...
                    if (utils_1.isNumeric(subs[2])) {
                        block = blocks_1.default.get1_13(blocks_1.default.std1_12(Number(subs[2])))
                            .getName()
                            .replace(/:/g, '.')
                            .replace(/\[.*$/g, '');
                    }
                    else {
                        block = blocks_1.default.get1_13(blocks_1.default.std1_12(undefined, `${subs[2]}:${subs[3]}`))
                            .getName()
                            .replace(/:/g, '.')
                            .replace(/\[.*$/g, '');
                    }
