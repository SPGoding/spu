    ...
    static isArgumentMatch(cmdArg, spusArg) {
        if (spusArg.charAt(0) === '%') {
            switch (spusArg.slice(1)) {
                case 'entity':
                    return (Checker.isSelector(cmdArg) ||
...
},{"./checker":1,"./spu_script":4,"./spuses":5,"./utils/argument_reader":6,"./utils/selector":9}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./utils/argument_reader":6,"./utils/char_reader":7,"./utils/selector":9}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Spuses {
}
