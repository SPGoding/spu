...
class UpdaterTo114 extends updater_1.Updater {
    ...
    upSpgodingCommand(input) {
        return wheel_chief_1.WheelChief.update(input, commands_1.Commands113To114.commands, new argument_parser_1.ArgumentParser(), this, new executor_1.SpuScriptExecutor113To114());
    }
