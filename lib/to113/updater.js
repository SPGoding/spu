...
class UpdaterTo113 extends updater_1.Updater {
    ...
    upSpgodingCommand(input) {
        const result = wheel_chief_1.WheelChief.update(input, commands_1.Commands112To113.commands, new argument_parser_1.ArgumentParser112To113(), this, new executor_1.SpuScriptExecutor112To113());
