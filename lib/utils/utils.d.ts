 ...
 */
export declare function getNbtCompound(str: string, version?: NbtFormat): import("../../../../../../SPGoding/project/Typescript/spu/src/utils/nbt/nbt").NbtCompound;
/**
 * Get an NbtList object from a string.
 */
export declare function getNbtList(str: string, version?: NbtFormat): import("../../../../../../SPGoding/project/Typescript/spu/src/utils/nbt/nbt").NbtList;
/**
