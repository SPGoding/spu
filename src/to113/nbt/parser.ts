 ...
 */
export class Parser {
    public parseCompounds(tokens: Token[], version: NbtFormat = 'after 1.12') {
    ...
    public parseLists(tokens: Token[], version: NbtFormat = 'after 1.12') {
        let result: ParseResult
     ...
     */
    private parseCompound(tokens: Token[], pos: number, version: NbtFormat): ParseResult {
    ...
    private parseList(tokens: Token[], pos: number, version: NbtFormat): ParseResult {
        let expectedTypes: TokenType[]
        const resultValue = new NbtList()
    ...
    private parseByteArray(tokens: Token[], pos: number): ParseResult {
        let expectedTypes: TokenType[]
        const resultValue = new NbtByteArray()
    ...
    private parseIntArray(tokens: Token[], pos: number): ParseResult {
        let expectedTypes: TokenType[]
        const resultValue = new NbtIntArray()
        let val: NbtInt | null
    ...
    private parseLongArray(tokens: Token[], pos: number): ParseResult {
        let expectedTypes: TokenType[]
        const resultValue = new NbtLongArray()
     ...
     */
    private parseValue(tokens: Token[], pos: number, version: NbtFormat): ParseResult {
        const token = tokens[pos]
        let val: NbtValue
