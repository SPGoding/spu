...
export default class Spuses {
    ...
    static pairs = new Map([
        ...
        ['clear %entity %item %item_data', 'clear %0 %1 %2'],
        ['clear %entity %item %item_data %num', 'clear %0 %1 %2 %3'],
        ['clear %entity %item %item_data %num %entity_nbt', 'clear %0 %1 %2 %3 %4'],
        ...
        ['clone %vec_3 %vec_3 %vec_3 %literal %literal %block', 'clone %0 %1 %2 %3 %4 %5'],
        [
            'clone %vec_3 %vec_3 %vec_3 %literal %literal %block %block_metadata',
            'clone %0 %1 %2 %3 %4 %5 %6'
        ],
        ['debug %literal', 'debug %0'],
        ['defaultword %word', 'defaultword %0'],
        ['deop %word', 'deop %0'],
        ...
        [
            'execute %entity ~ ~ ~ detect %vec_3 %block %block_metadata %command',
            'execute as %0 at @s if block %1 %2$addDataOrStateToBlock%3 run %4'
        ],
        [
            'execute %entity %vec_3 detect %vec_3 %block %block_metadata %command',
        ...
        ['fill %vec_3 %vec_3 %block %block_metadata', 'fill %0 %1 %2$addDataOrStateToBlock%3'],
        ['fill %vec_3 %vec_3 %block %block_metadata %literal', 'fill %0 %1 %2$addDataOrStateToBlock%3 %4'],
        [
            'fill %vec_3 %vec_3 %block %block_metadata %literal %block_nbt',
            'fill %0 %1 %2$addDataOrStateAndNbtToBlock%3%5 %4'
        ],
        [
            'fill %vec_3 %vec_3 %block %block_metadata replace %block',
            'fill %0 %1 %2$addDataOrStateToBlock%3 replace %4'
        ],
        [
            'fill %vec_3 %vec_3 %block %block_metadata replace %block %block_metadata',
        ...
        [
            'particle %particle %vec_3 %vec_3 %num %num %literal %entity %int',
            'particle %0 %7 %1 %2 %3 %4 %5 %6'
        ],
        [
            'particle %particle %vec_3 %vec_3 %num %num %literal %entity %int %int',
            'particle %0 %7 %1 %2 %3 %4 %5 %6'
        ],
        ...
        ['setblock %vec_3 %block %block_metadata', 'setblock %0 %1$addDataOrStateToBlock%2'],
        ['setblock %vec_3 %block %block_metadata %literal', 'setblock %0 %1$addDataOrStateToBlock%2 %3'],
        [
            'setblock %vec_3 %block %block_metadata %literal %block_nbt',
        ...
        ['testforblock %vec_3 %block %block_metadata', 'execute if block %0 %1$addDataOrStateToBlock%2'],
        [
            'testforblock %vec_3 %block %block_metadata %block_nbt',
