...
export default class Spuses {
    ...
    static pairs = new Map([
        ...
        ['replaceitem entity %entity %word %word', 'replaceitem block %0 %1 %2'],
        ['replaceitem entity %entity %word %word %num', 'replaceitem block %0 %1 %2 %3'],
        ['replaceitem entity %entity %word %word %num %num', 'replaceitem block %0 %1 %2 %3 %4'],
        ['replaceitem entity %entity %word %word %num %num %item_tag_nbt', 'replaceitem block %0 %1 %2 %3 %4 %5'],
        ['save-all', 'save-all'],
